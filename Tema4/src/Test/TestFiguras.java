    ...
    public static void menu() {
        ...
        do {
            ...
            switch (sel) {
                case "Triangulo":
                    if(j<10){
                        Figura Triangulo=new Triangulo("Triangulo","Rojo",
                                Tools.leerInt("Ingrese la base"),
                                Tools.leerInt("Ingrese la altura"));
                        arrFig[j]=Triangulo;
                        j++;
                    }else{
                ...
                case "Cuadrado":
                   if(j<10){
                        Figura Cuadrado=new Cuadrado("Cuadrado","Azul",
                                Tools.leerInt("Ingrese un lado"));
                        arrFig[j]=Cuadrado;
                        j++;
                    }else{
                        Tools.imprimePantalla("No puedes ingresar mas datos");
                ...
                case "Rectangulo":
                    if(j<10){
                        Figura Rectangulo=new Rectangulo("Rectangulo","Negro",
                                Tools.leerInt("Ingrese un la base"),
                                Tools.leerInt("Ingrese la altura"));
                        arrFig[j]=Rectangulo;
                        j++;
                    }else{
